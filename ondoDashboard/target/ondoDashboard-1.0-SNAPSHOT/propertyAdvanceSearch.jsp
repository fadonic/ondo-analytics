<%-- 
    Document   : propertyAdvanceSearch
    Created on : Nov 5, 2018, 11:15:41 AM
    Author     : CSDC
--%>
                                        ...
                                        <form class="form-vertical">
                                            <fieldset>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" placeholder="Reg Date" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-group col-sm-6">
                                                            <input type="email" class="form-control" placeholder="House No." />
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <input type="email" class="form-control" placeholder="Street Type" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="range" class="form-control slider" min="1" max="100" value="50"  id="myRange">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-group col-sm-6">
                                                            <input type="email" class="form-control" placeholder="300000.49" />
                                                        </div>
                                                        <div class="form-group col-sm-6">
                                                            <input type="email" class="form-control" placeholder="300000.49" />
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label class="control-label">Area (Square Meters)</label>
                                                            <input type="range" class="form-control slider" min="1" max="100" value="50"  id="myRange">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
